...
description: "2026-07 경쟁 지형 판정 — 이동성 단독 차별점 사망(혼잡); 사용자 소유·벤더 횡단 스코프는 공백; 조합 해자(소유+스코프+정밀 선택+게이트 환류+브리핑 팩) 전부 하는 곳 없음; 위협 1티어 = mem0·Anthropic·AWS AgentCore(담장 안 풀스택); 정본 = docs/리서치/MCO_경쟁지형_v0_1.md"
metadata:
  type: project
---
